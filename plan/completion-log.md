...
2026-03-22 | GT15 | done | - | Fresh-repo acceptance: template→init→bootstrap→governed path validated. 25/25 assertions across two paths (default-branch-only full acceptance, all-branches D32 validation). All prior suites green (137 total). GT16 unblocked.
2026-03-22 | GT16 | done | - | Hardening complete: KNOWN-LIMITATIONS.md, split policy in decisions.md, version tag criteria in roadmap.md, release summary in README. All 162 assertions still pass. Initial roadmap (GT0–GT16) finished.
